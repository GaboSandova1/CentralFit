  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-gutter bg-surface-container-lowest/80 backdrop-blur-sm">
      ...
      <div className="bg-surface-container w-full max-w-2xl rounded-xl border border-outline-variant flex flex-col shadow-2xl relative overflow-hidden transform transition-all">
        {/* Modal Header */}
        <div className="px-container-padding py-card-gap flex justify-between items-center border-b border-outline-variant bg-surface-container">
        ...
        <div className="p-container-padding flex flex-col gap-container-padding overflow-y-auto max-h-[70vh] bg-surface-container-low">
          ...
          <section className="flex flex-col gap-card-gap">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-label-md text-label-md text-on-surface uppercase tracking-wider">Tasa del Día (BCV)</h3>
            </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1 group">
                      ...
                      <input className="block w-full pl-10 pr-3 py-3 bg-surface-container border border-outline-variant rounded-lg text-on-surface font-body-md focus:ring-1 focus:ring-primary focus:border-primary transition-colors" id="primary-rate" placeholder="0.00" type="text" defaultValue="36.50" />
                    </div>
                    <div className="relative">
                      <select className="appearance-none h-full px-4 pr-10 bg-surface-container border border-outline-variant rounded-lg text-on-surface font-label-md focus:ring-1 focus:ring-primary focus:border-primary transition-colors cursor-pointer">
          ...
          <section className="flex flex-col gap-card-gap">
            ...
            <div className="bg-surface border border-outline-variant rounded-lg flex flex-col overflow-hidden">
              ...
              <div className="flex items-center justify-between p-card-gap hover:bg-surface-container transition-colors">
                ...
                <div className="w-24">
                  <input className="block w-full px-3 py-2 bg-surface-container border border-outline-variant rounded-lg text-on-surface font-body-md text-center focus:ring-1 focus:ring-primary focus:border-primary transition-colors" id="grace-days" max="30" min="0" type="number" defaultValue="3" placeholder="3" />
                </div>
              </div>
            </div>
          </section>
