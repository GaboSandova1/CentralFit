...
export default function Sidebar({ isOpen, onClose, onOpenRenovation, onOpenSettings }: SidebarProps) {
          ...
          {navItems.map((item) => {
            ...
            return (
              <li key={item.path}>
                ...
                >
                  <span
                    className={`material-symbols-outlined ${isActive ? 'icon-fill' : 'group-hover:text-primary transition-colors'}`}
